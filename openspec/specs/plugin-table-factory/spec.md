# plugin-table-factory Specification

## Purpose
Define the zero-config plugin table helper, including prefixed table naming, platform field injection, and build-time plugin id resolution.
## Requirements
